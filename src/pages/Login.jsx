...
const Login = () => {
  ...
  const NAVER_AUTH_URL = `https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=KdnHuDfQRJ8OKSLDdgB6&state=randomtext&redirect_uri=http://i8d111.p.ssafy.io/oauth/naver/callback`;
  const onClickKakao = () => {
